...
namespace WeatherAggregator.Data
{
    ...
    public partial class OpenWeatherDeserializer
    {
    ...
    public partial class OpenWeatherDeserializer
    {
        public static OpenWeatherDeserializer FromJson(string json) => JsonConvert.DeserializeObject<OpenWeatherDeserializer>(json, Converter.Settings);
    }
